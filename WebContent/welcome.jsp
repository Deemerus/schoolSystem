...
<b>You can log in to test users by using following usernames: admin, teacher, smithj.<br/>
Password to every test account is the same: password (you can use it even after changing the password).<br/></b>
For obvious reasons these accounts cannot be deleted by admin.</p>
<p>During creation of this project my main interest was to learn back-end part of developing web applications using JavaEE. I tried to make it look decently, but appearance wasn't my main focus.
...
Website created by Szymon Balcer. Source code available <a href="https://github.com/Deemerus/schoolSystem">here</a>.</p>
